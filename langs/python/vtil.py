...
class Vtil(KaitaiStruct):
    ...
    def _read(self):
        ...
        self.entry_point = self._root.EntryPoint(self._io, self, self._root)
    ...
    class ExploredBlocks(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.explored_block = [None] * (self.explored_blocks_amount)
            for i in range(self.explored_blocks_amount):
                self.explored_block[i] = self._root.BasicBlock(self._io, self, self._root)
